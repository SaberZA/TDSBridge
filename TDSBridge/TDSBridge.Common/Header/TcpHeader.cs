...
{ 
    ...
    { 
        ...
        { 
            ...
            { 
                Trace.TraceError(ex.Message, "Network Sniffer" + (nReceived)); 
            } 
        } 
...
//        }
        ...
        public string GetBatchText(int payloadLength)
        {
            byte[] bPayload = Data;
            Header.AllHeader _allHeader = new Header.AllHeader(bPayload);

//            int iHeaderLength = (int)bPayload.Length;
            int iHeaderLength = payloadLength;
            string batchText;
            try
            {
//                batchText = System.Text.Encoding.Unicode.GetString(
//                    bPayload,
//                    iHeaderLength,
//                    bPayload.Length - iHeaderLength);
                batchText = System.Text.Encoding.ASCII.GetString(
                    bPayload,
                    0,
                    iHeaderLength);
            }
